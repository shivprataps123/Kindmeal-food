            ...
            <div className="div">
              ...
              <div className="div-fetch">
                ...
                <div>
                  <div className="div-fetch">
                    ...
                    <h2>
                      Servings <spam style={{ color: "green" }}>Depends</spam>
                    </h2>
                  </div>
                  <div className="div-fetch">
                    <div>
              ...
              <div className="order">
                <div>
                  <h1>Description</h1>
                  <p>
                    Your daily lunch is looking sad. Instead of settling for yet
                    another boring diet meal, mix up your midday meal routine
                    with one of these 10 healthy lunch ideas for weight loss.
                    These are not only will you fill up on the good stuff, but
                    these are easy recipes and seriously affordable
                  </p>
                ...
                <div className="p">
                  ...
                  <ol>
                    <li>
                      {" "}
                      Cut whole wheat bread into square then add one tea spoon
                      of olive oil and get into baked. Slice spinach put in
                      spinach into the bowl and then add some chickpeas (canned
                      or boilled). add cut whole wheat bread into the bowl
                      together with the spinach. For dressing add one clove, tea
                      spoon of olive, tea spoon of lemon juice, salt and pepper
                      then add dressing into the bowl.
                    </li>
                  </ol>
                </div>
              </div>
          ...
          <div>
            <div className="raterecipe">
              <div className="rate-div">
                ...
                <img
                  className="star"
                  src="https://tse4.mm.bing.net/th?id=OIP.QOhwh1JLNOHV6U0URqQpAAHaCt&pid=Api&P=0"
                />
                <p>No Rating</p>
